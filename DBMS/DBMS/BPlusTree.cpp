 ...
 */
node * BPlusTree::find_leaf( node * root, int key, bool verbose ) {
	int i = 0;
	node * c = root;
	if (c == NULL) {
		if (verbose)
 ...
 * a key refers.
 */
record * BPlusTree::find( node * root, int key, bool verbose ) {
	int i = 0;
 ...
 */
void BPlusTree::find_and_print(node * root, int key, bool verbose) {
 ...
 * properties.
 */
node * BPlusTree::insert_node( node * root, int key, int value ) {
 ...
 */
node * BPlusTree::delete_nodes(node * root, int key) {
